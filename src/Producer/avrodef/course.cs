...
namespace avrodef
{
	...
	{
		public static global::Avro.Schema _SCHEMA = global::Avro.Schema.Parse("{\"type\":\"record\",\"name\":\"course\",\"namespace\":\"kafka-cluster\",\"fields\":[{\"name\":\"i" +
				"d\",\"type\":\"string\"},{\"name\":\"description\",\"type\":\"string\"}]}");
		private string _id;
